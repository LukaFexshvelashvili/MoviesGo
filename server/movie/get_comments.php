...
if(is_logged() && $comment['author_id'] == $_SESSION['user_id']){
        ?>
        <button data-comment-id="<?php echo $comment['comment_id']; ?>" class="dbtw delete_comment">წაშლა</button>
        <?php
...
if(is_logged() && $replied['author_id'] == $_SESSION['user_id']){
        ?>
        <button data-comment-id="<?php echo $replied['comment_id']; ?>" class="dbtw delete_comment">წაშლა</button>
        <?php
