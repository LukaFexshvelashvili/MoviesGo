...
if($_GET["title"]){
    ...
    $stmt = $conn->prepare("SELECT id, genres, description, poster_url, thumbnail_url, subtitle, name, name_eng, imdb, type, year, country, creator FROM movies WHERE name LIKE ? OR name_eng LIKE ? ORDER BY year DESC LIMIT 4");
