...
<body>
    ...
    <div class="container cnt watch_block">
        <div class="watch_place"></div>
        <div class="watch_logs">
            <div class="players">
                <div class="cnt active_player">ფლეერი 1</div>
                <div class="cnt">ფლეერი 2</div>
                <div class="cnt">ფლეერი 3</div>
            </div>
            <div class="movie_actions">
                ...
                <div class="movie_love movie_action_button cnt">
                ...
                <div class="movie_watchlater movie_action_button cnt">
    ...
    <div class="container">
        <div class="movie_info">
            <div class="movie_poster">
                <img src="<?php echo $image_starter.$movie['poster_url']?>" alt="" />
            </div>
        ...
        <div class="mg_cardslider">
            ...
            <div class="mg_cardslider_row"></div>
        </div>
    </div>
