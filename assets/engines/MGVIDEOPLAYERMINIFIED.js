...
let mg_main_controls,
  active_season = MG_PLAYER.seasons ? Object.keys(MG_PLAYER.seasons)[0] : 1,
  active_episode = 1;
...
initializePlayer(),
  ...
  mg_video.addEventListener("playing", () => {
    mg_error_block.classList.add("mg_error_hidden"), setLoading(!1);
  }),
  ...
  if (localStorage.getItem("mg_player")) {
    ...
    0 !== t.length
      ? (movetoFirstItem(
        ...
        "SERIES" == MG_PLAYER.type &&
          (Object.keys(MG_PLAYER.seasons).includes(t[0].season.toString()) &&
          t[0].episode >= 0 &&
